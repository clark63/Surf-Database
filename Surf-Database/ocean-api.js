...
// Cache key is region-specific — prevents stale data from a previous region showing up
const CACHE_KEY   = `surf_cache_${ACTIVE_REGION_ID}`;
...
function cacheKey() { return `surf_cache_${ACTIVE_REGION_ID}`; }
...
function ratingLabel(score) {
  ...
  if (score <= 75) return { label:"Good",  color:"#a3e635", bg:"rgba(163,230,53,0.14)",  border:"#a3e635" };
